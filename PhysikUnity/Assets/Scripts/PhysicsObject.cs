...
{
    public Material awakeMaterial = null; public Material sleepingMaterial = null; private Rigidbody _rigidbody = null; bool wasSleeping = false; // Use this for initialization 
    void Start ()
    {
